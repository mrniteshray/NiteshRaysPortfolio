        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="lg:col-span-2 flex justify-center">
            <div className="relative">
              <div className="w-64 h-64 sm:w-80 sm:h-80 rounded-full bg-gradient-to-r from-kotlin to-indigo-500 p-1">
              ...
              <div className="absolute -top-4 -left-4 w-20 h-20 rounded-full bg-gradient-to-br from-[#4285F4] to-purple-500 flex items-center justify-center text-white font-bold shadow-lg group-hover:-rotate-12 transition-transform duration-300">
                Compose
              </div>
            </div>
          </div>
