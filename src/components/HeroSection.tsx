...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center pt-20 pb-16 bg-gradient-to-br from-background via-muted/10 to-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          <div className="lg:col-span-3 space-y-8">
            <p className="text-primary font-mono font-medium tracking-wider">Hi there, I'm</p>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-muted-foreground leading-tight h-16">
              <span className="inline-block min-w-[240px]">{displayText}</span>
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Button asChild className="h-11 px-6 text-base bg-primary hover:bg-primary/90 transition-all hover:scale-[1.02]">
                <a href="#projects">
                  View Projects <ArrowRight size={18} className="ml-2" />
                </a>
              </Button>
              <Button variant="outline" asChild className="h-11 px-6 text-base border-2 hover:border-primary transition-all hover:scale-[1.02]">
            ...
            <div className="flex gap-4 pt-4">
              <a href="https://github.com/mrniteshray/" target="_blank" rel="noopener noreferrer" 
                className="social-icon w-10 h-10 rounded-full bg-muted flex items-center justify-center hover:bg-primary hover:text-white transition-all hover:scale-110">
                <Github size={20} />
              </a>
          ...
          <div className="lg:col-span-2 flex justify-center relative">
            <div className="relative group">
              <div className="w-64 h-64 sm:w-80 sm:h-80 rounded-full bg-gradient-to-r from-[#7F52FF] via-[#FF7D7D] to-[#FFAB4C] p-1.5 animate-gradient-xy">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 rounded-full bg-gradient-to-br from-[#7F52FF] to-[#FF7D7D] flex items-center justify-center text-white font-bold shadow-lg group-hover:rotate-12 transition-transform duration-300">
                Kotlin
              </div>
              <div className="absolute -top-4 -left-4 w-20 h-20 rounded-full bg-gradient-to-br from-[#4285F4] to-[#34A853] flex items-center justify-center text-white font-bold shadow-lg group-hover:-rotate-12 transition-transform duration-300">
                Compose
              </div>
            </div>
          </div>
